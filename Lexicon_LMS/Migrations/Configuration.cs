        ...
        protected override void Seed(Lexicon_LMS.Models.ApplicationDbContext context)
        {
            ...
            context.Courses.AddOrUpdate(
               ...
               new Course
               {
                   ...
                   CourseId = 7,
                   Teacher = "Oscar Jakobsson",
                   Description = "Fastställa kravspec.",
            ...
            context.Activities.AddOrUpdate(
                ...
                new Activity
                {
                    ...
                    Name = "Bootstrap",
                    Teacher = "Oscar Jakobsson",
                    Description = "I denna kurs kommer vi att lära oss mer om Bootstrap",
                 ...
                 new Activity
                {
                      CourseId = 7,
                    Type = "Lärarledd kurs",
                      Name = "LMS fortsättning",
                    Teacher = "Oscar Jakobsson",
                      Description = "LMS grupparbete fortsättning",
